...
el('searchButton').onclick = () => {
    ...
    listActiveSubscriptionByAuthor(keyword);
};
...
function listActiveSubscriptionByAuthor(consumerId) {
    output.innerHTML = 'Loading ...';
    dcore_js.subscription().listActiveSubscriptionsByAuthor(consumerId)
        .then(res => {
            output.innerHTML = '';

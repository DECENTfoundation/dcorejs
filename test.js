...
//         .catch(err => console.log(err));
    ...
    // dcorejs.mining().createMiner('1.2.27', '',  dcorejs.Utils.getPublicKey(dcorejs.Utils.privateKeyFromWif('5KcA6ky4Hs9VoDUSdTF4o3a7QDgiiG5gkpLLysRWR8dy6EAgTnZ')).stringKey, '5KcA6ky4Hs9VoDUSdTF4o3a7QDgiiG5gkpLLysRWR8dy6EAgTnZ')
    //     .then(res => console.log(res)).catch(err => console.log(err));
    // dcorejs.explorer().listMiners()
    //     .then(res => console.log(res))
    //     .catch(err => console.log(err));
    // dcorejs.account().voteForMiner('1.4.12', '1.2.27', '5KcA6ky4Hs9VoDUSdTF4o3a7QDgiiG5gkpLLysRWR8dy6EAgTnZ')
    //     .then(res => console.log(res))
    //     .catch(err => console.log(err));
    // dcorejs.account().listAccountBalances('1.2.27')
    //     .then(res => console.log(res))
    //     .catch(err => console.log(err));
    dcorejs.asset().createMonitoredAsset(
        '1.2.27',
        'DUSMON',
        0,
        'Monitored dus token',

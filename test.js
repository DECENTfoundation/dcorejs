...
function nehe() {
    ...
    dcorejs.content().getContent('2.13.240')
        .then(res => console.log(JSON.stringify(res)))
        .catch(err => console.log(err));
    ...
    // dcorejs.account().voteForMiner('1.4.7', '1.2.27', '5KcA6ky4Hs9VoDUSdTF4o3a7QDgiiG5gkpLLysRWR8dy6EAgTnZ').then(res => console.log(res)).catch(err => console.log(err));
    // dcorejs.account().unvoteMiner('1.4.7', '1.2.27', '5KcA6ky4Hs9VoDUSdTF4o3a7QDgiiG5gkpLLysRWR8dy6EAgTnZ').then(res => console.log(res)).catch(err => console.log(err));
